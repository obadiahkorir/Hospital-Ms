...
<nav class="navbar clearHeader">
    <div class="col-12">
        <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand" href="iadmin_home.php">Diabetes Hospital</a> </div>
...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>SUGAR LEVEL MANAGEMENT PORTAL</h2>
                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                               <?php
                                ...
                                $result=mysqli_query($conn,"SELECT * FROM sugar ORDER BY id"); //rs.open sql,con
