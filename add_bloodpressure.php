    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>Blood Pressure Information <small>PLEASE FILL IN THE BLOOD PRESSURE DETAILS...</small> </h2>
					...
					<div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <form action="include/insertpressure.php" method="POST">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-3 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class=" form-control" name="systolic" placeholder="Enter Systolic">
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="col-sm-3 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class=" form-control" name="diastolic" placeholder="Enter Diastolic">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3 col-xs-12">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="pulse" placeholder="Enter Your Pulse Rate">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="type" placeholder="Enter Diabetes Type">
                                    </div>
                                </div>
                            </div>
