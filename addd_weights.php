    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>Appointment Information <small>PLEASE FILL IN THE APPPOINTMENT DETAILS...</small> </h2>
					...
					<div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <form action="include/register_appointment.php" method="POST">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-3 col-xs-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="datepicker form-control" name="dates" placeholder="Appointment Date">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3 col-xs-12">
                                <div class="form-group drop-custum">
                                    <select class="form-control show-tick" name="db_type">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-12">
                             ...
                             <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="name" placeholder="Patient Names">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
