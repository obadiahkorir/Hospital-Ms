    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>Weights Information <small>PLEASE FILL IN THE WEIGHT DETAILS...</small> </h2>
					...
					<div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <form action="include/insertweights.php" method="POST">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="weights" placeholder="Enter Weights(Kgs)">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
